...
│         │                  │                  │                │
│  ┌──────▼──────┐    ┌──────▼──────┐    ┌──────▼──────┐         │
│  │ Yahoo API   │    │ 네이버 크롤링 │    │ Gemini AI   │         │
│  │ Finnhub API │    │ 다음 API     │    │ (분석/요약)  │         │
│  │ Playwright  │    │ KRX API      │    └─────────────┘         │
│  │ (캡처+AI)   │    │ 공공데이터    │                           │
│  └─────────────┘    │ Twelve Data  │                           │
│                     │ Playwright   │                           │
...
### 미국 주식
1. **Primary:** Yahoo Finance API (`yahoo-finance2`)
2. **Secondary:** Finnhub API
3. **Fallback:** Agentic Screenshot + Gemini Vision

### 한국 주식
1. **Primary:** 네이버 금융 크롤링
2. **Secondary:** 다음 금융 API
